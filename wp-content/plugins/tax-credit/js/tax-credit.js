...
document.addEventListener("DOMContentLoaded", function(e) {
    ...
    submitButton.onclick = function(e) {
        ...
        const emailGeneric = `
            ...
            <p>
                You are receiving this email because you used Access RDSP's Disability Tax Credit Web Tool. <b>This email contains a letter to your health care provider and a summary of your restrictions that are relevant to the Disability Tax Credit Application.</b>
            </p>
            ...
            <p>
                Below is a letter to provide to your medical professional. <b>Please complete the section with your information (name and DOB).</b>
            </p>
            <hr>
            
            <h2>Supporting Document 1: Letter to your Medical Practitioner</h2>
            ...
            <p>
                <b>
                    <mark>Re:     (Client Name), DOB: (DD/MMM/YYYY)</mark><br>
            ...
            <hr>
            <h2>Supporting Document 2: Disability Tax Credit Application Supplement: Effects of Impairment</h2>
