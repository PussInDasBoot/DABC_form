    ...
    <div class="panel">
      <table>
            ...
            <tr id="mentalCare">
                ...
                <td>
                    <div class="radio">
                        <input type="radio" name="mentalCare" id="mentalCareNo" value="no">
                        <label for="mentalCareNo">
                            No
                        </label>
                    </div>
                    <div class="radio">
                        <input type="radio" name="mentalCare" id="mentalCareSupport" value="support">
                        <label for="mentalCareSupport">
                            I receive support from mental health specialists.
                        </label>
                    </div>
                    <div class="radio">
                        <input type="radio" name="mentalCare" id="mentalCareMedication" value="medication">
